...
class GiveMemberRoles(commands.Cog):
    ...
    @user_command(name='Member | Register', default_member_permissions=discord.Permissions(manage_roles=True), guild_ids=guilds)
    async def give_member_roles(self, message, user):
